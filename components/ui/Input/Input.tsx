...
const baseInputClass =
  'w-full rounded-md border bg-white px-3 py-2.5 font-sans text-body text-tertiary placeholder:text-neutral/60 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed'
